...
export default function RegisterPage() {
    ...
    // isloading supaya user tidak klik terus"an tombol register
        ...
        <div className="h-screen w-100 flex justify-center items-center flex-col">
            ...
            <div className="bg-white shadow-md border border-gray-200 rounded-lg w-96 p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div>
                    ...
                    <input type="text" name="fullname" id="fullname" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="fullname" required />
                </div>
                <div>
                ...
                {isLoading ? "Loading..." : "Sign up account"}</button>
                <div className="text-sm font-medium text-gray-500 dark:text-gray-300"> Have registered?{" "} <Link href="/login" className="text-blue-700 hover:underline dark:text-blue-500">Sign in here</Link>
                </div>
            </form>
        </div>
    </div>
